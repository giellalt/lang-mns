...
This directory contains source files for the Mansi language morphology
...
In order to compile and use Mansi language morphology and dictionaries,
you need:
...
The Mansi language sources can be acquired using [giella SVN
