...
#	s/ C-FI-NEN/nen LONDON/g ;
	...
	s/(о|а|я|ё|у|ю|и|ы|е|э|О|А|Я|Ё|У|Ю|И|Ы|Е|Э)(щ) (PROP-PLC_OSH)/$1$2 N_VCS/g ;
        ...
        s/(о|а|я|ё|у|ю|и|ы|е|э|О|А|Я|Ё|У|Ю|И|Ы|Е|Э)(б|в|г|д|ж|з|к|л|м|н|п|р|с|т|ф|х|ц|ч|ш)(щ) (PROP-PLC_OSH)/$1$2$3 N_VCCS/g ;
        s/(о|а|я|ё|у|ю|и|ы|е|э|О|А|Я|Ё|У|Ю|И|Ы|Е|Э)(б|в|г|д|ж|з|к|л|м|н|п|р|с|т|ф|х|ц|ч|ш)(б|в|г|д|ж|з|к|л|м|н|п|р|с|т|ф|х|ц|ч|ш)(с) (PROP-PLC_OSH)/$1$2$3 N_VCCCH/g ;
        s/(о|а|я|ё|у|ю|и|ы|е|э|О|А|Я|Ё|У|Ю|И|Ы|Е|Э)(б|в|г|д|ж|з|к|л|м|н|п|р|с|т|ф|х|ц|ч|ш)(б|в|г|д|ж|з|к|л|м|н|п|р|с|т|ф|х|ц|ч|ш)(щ) (PROP-PLC_OSH)/$1$2$3 N_VCCCS/g ;
